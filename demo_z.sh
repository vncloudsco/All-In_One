...
if [[ $OSVER == "CentOS6" ]]; then
    ...
    wget https://files.zimbra.com/downloads/8.8.11_GA/zcs-8.8.11_GA_3737.RHEL6_64.20181207111719.tgz
fi
...
echo "Ban Can Luu Tru Cac Thong Tin Dang Nhap Sau Day De Su Dung"
echo "Yeu cau doi mat khau sau khi dang nhap"
